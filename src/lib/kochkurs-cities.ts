...
export const KOCHKURS_CITIES: Record<string, KochkursCity> = {
  berlin: { slug: 'berlin', name: 'Berlin', bundesland: 'berlin', bundeslandName: 'Berlin', lat: 52.52, lng: 13.405, volume: 3600, neighbors: ['magdeburg', 'leipzig', 'dresden'] },
  hamburg: { slug: 'hamburg', name: 'Hamburg', bundesland: 'hamburg', bundeslandName: 'Hamburg', lat: 53.5511, lng: 9.9937, volume: 3600, neighbors: ['bremen', 'oldenburg', 'hannover'] },
  ...
  koeln: { slug: 'koeln', name: 'Köln', bundesland: 'nordrhein-westfalen', bundeslandName: 'Nordrhein-Westfalen', lat: 50.9375, lng: 6.9603, volume: 2900, neighbors: ['bonn', 'duesseldorf', 'bochum'] },
  ...
  duesseldorf: { slug: 'duesseldorf', name: 'Düsseldorf', bundesland: 'nordrhein-westfalen', bundeslandName: 'Nordrhein-Westfalen', lat: 51.2277, lng: 6.7735, volume: 1900, neighbors: ['koeln', 'bochum', 'dortmund'] },
  ...
  nuernberg: { slug: 'nuernberg', name: 'Nürnberg', bundesland: 'bayern', bundeslandName: 'Bayern', lat: 49.4521, lng: 11.0767, volume: 1300, neighbors: ['regensburg', 'wuerzburg', 'augsburg'] },
  leipzig: { slug: 'leipzig', name: 'Leipzig', bundesland: 'sachsen', bundeslandName: 'Sachsen', lat: 51.3397, lng: 12.3731, volume: 1300, neighbors: ['dresden', 'magdeburg', 'berlin'] },
  dresden: { slug: 'dresden', name: 'Dresden', bundesland: 'sachsen', bundeslandName: 'Sachsen', lat: 51.0504, lng: 13.7373, volume: 1000, neighbors: ['leipzig', 'berlin', 'magdeburg'] },
  dortmund: { slug: 'dortmund', name: 'Dortmund', bundesland: 'nordrhein-westfalen', bundeslandName: 'Nordrhein-Westfalen', lat: 51.5136, lng: 7.4653, volume: 880, neighbors: ['bochum', 'muenster', 'duesseldorf'] },
  ...
  karlsruhe: { slug: 'karlsruhe', name: 'Karlsruhe', bundesland: 'baden-wuerttemberg', bundeslandName: 'Baden-Württemberg', lat: 49.0069, lng: 8.4037, volume: 880, neighbors: ['mannheim', 'stuttgart', 'darmstadt'] },
  bonn: { slug: 'bonn', name: 'Bonn', bundesland: 'nordrhein-westfalen', bundeslandName: 'Nordrhein-Westfalen', lat: 50.7374, lng: 7.0982, volume: 880, neighbors: ['koeln', 'koblenz', 'duesseldorf'] },
  ...
  mannheim: { slug: 'mannheim', name: 'Mannheim', bundesland: 'baden-wuerttemberg', bundeslandName: 'Baden-Württemberg', lat: 49.4875, lng: 8.466, volume: 720, neighbors: ['darmstadt', 'karlsruhe', 'mainz'] },
  ...
  braunschweig: { slug: 'braunschweig', name: 'Braunschweig', bundesland: 'niedersachsen', bundeslandName: 'Niedersachsen', lat: 52.2689, lng: 10.5268, volume: 720, neighbors: ['hannover', 'magdeburg', 'kassel'] },
  // --- Welle 2 ---
  wuerzburg: { slug: 'wuerzburg', name: 'Würzburg', bundesland: 'bayern', bundeslandName: 'Bayern', lat: 49.7913, lng: 9.9534, volume: 720, neighbors: ['nuernberg', 'darmstadt', 'frankfurt'] },
  ...
  kassel: { slug: 'kassel', name: 'Kassel', bundesland: 'hessen', bundeslandName: 'Hessen', lat: 51.3127, lng: 9.4797, volume: 590, neighbors: ['bielefeld', 'hannover', 'braunschweig'] },
  ...
  bochum: { slug: 'bochum', name: 'Bochum', bundesland: 'nordrhein-westfalen', bundeslandName: 'Nordrhein-Westfalen', lat: 51.4818, lng: 7.2162, volume: 590, neighbors: ['dortmund', 'duesseldorf', 'muenster'] },
  aachen: { slug: 'aachen', name: 'Aachen', bundesland: 'nordrhein-westfalen', bundeslandName: 'Nordrhein-Westfalen', lat: 50.7753, lng: 6.0839, volume: 590, neighbors: ['koeln', 'duesseldorf', 'bonn'] },
  ...
  magdeburg: { slug: 'magdeburg', name: 'Magdeburg', bundesland: 'sachsen-anhalt', bundeslandName: 'Sachsen-Anhalt', lat: 52.1205, lng: 11.6276, volume: 480, neighbors: ['braunschweig', 'leipzig', 'berlin'] },
};
