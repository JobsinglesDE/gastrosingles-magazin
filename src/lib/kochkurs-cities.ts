...
export const KOCHKURS_CITIES: Record<string, KochkursCity> = {
  ...
  stuttgart: { slug: 'stuttgart', name: 'Stuttgart', bundesland: 'baden-wuerttemberg', bundeslandName: 'Baden-Württemberg', lat: 48.7758, lng: 9.1829, volume: 1900, neighbors: ['karlsruhe', 'ulm', 'heidelberg'] },
  ...
  duesseldorf: { slug: 'duesseldorf', name: 'Düsseldorf', bundesland: 'nordrhein-westfalen', bundeslandName: 'Nordrhein-Westfalen', lat: 51.2277, lng: 6.7735, volume: 1900, neighbors: ['wuppertal', 'essen', 'koeln'] },
  ...
  karlsruhe: { slug: 'karlsruhe', name: 'Karlsruhe', bundesland: 'baden-wuerttemberg', bundeslandName: 'Baden-Württemberg', lat: 49.0069, lng: 8.4037, volume: 880, neighbors: ['heidelberg', 'mannheim', 'stuttgart'] },
  ...
  kassel: { slug: 'kassel', name: 'Kassel', bundesland: 'hessen', bundeslandName: 'Hessen', lat: 51.3127, lng: 9.4797, volume: 590, neighbors: ['goettingen', 'bielefeld', 'erfurt'] },
...
// --- Welle 3 ---
  ...
  heidelberg: { slug: 'heidelberg', name: 'Heidelberg', bundesland: 'baden-wuerttemberg', bundeslandName: 'Baden-Württemberg', lat: 49.3988, lng: 8.6724, volume: 480, neighbors: ['mannheim', 'karlsruhe', 'darmstadt'] },
  essen: { slug: 'essen', name: 'Essen', bundesland: 'nordrhein-westfalen', bundeslandName: 'Nordrhein-Westfalen', lat: 51.4556, lng: 7.0116, volume: 480, neighbors: ['bochum', 'wuppertal', 'duesseldorf'] },
