...
export const SHOW_HUBS: Record<string, Hub> = {
  'kitchen-impossible': {
    ...
    seoTitle: 'Kitchen Impossible: Mälzer & Gäste',
    seoDescription:
  ...
  'grill-den-henssler': {
    ...
    seoTitle: 'Grill den Henssler: Steffen & Promis',
    seoDescription:
  ...
  'rosins-restaurants': {
    ...
    seoTitle: 'Rosins Restaurants: Frank Rosin',
    seoDescription:
  ...
  'promi-koeche': {
    ...
    seoTitle: 'Promi-Köche: Porträts & Vermögen',
    seoDescription:
...
export const BERUF_HUBS: Record<string, Hub> = {
  'koch': {
    ...
    seoTitle: 'Koch werden: Ausbildung & Gehalt',
    seoDescription:
  ...
  'sommelier': {
    ...
    seoTitle: 'Sommelier: Ausbildung & Karriere',
    seoDescription:
  ...
  'kuechenchef': {
    ...
    seoTitle: 'Küchenchef: Aufgaben & Gehalt',
    seoDescription:
  ...
  'barkeeper': {
    ...
    seoTitle: 'Barkeeper: Ausbildung & Job',
    seoDescription:
...
export const SINGLE_HUB: Hub = {
  ...
  seoTitle: 'Gastro-Singles: Partnersuche Gastronomie',
  seoDescription:
...
export const SECTION_HUBS: Record<string, Hub> = {
  'tv-koch-shows': {
    ...
    seoTitle: 'Koch-Shows: Promiköche & TV-News',
    seoDescription:
  ...
  'berufsbilder': {
    ...
    seoTitle: 'Gastro-Berufe: Koch, Sommelier & Co.',
    seoDescription:
