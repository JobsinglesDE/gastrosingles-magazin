...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!author) return {};
  return {
    title: `${author.name} — Autor | Gastrosingles Magazin`,
    description: author.bio || `Artikel von ${author.name} auf dem Gastrosingles Magazin.`,
...
export default async function AuthorPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const personJsonLd = {
    ...
    '@type': 'Person',
    name: author.name,
    url: `https://gastrosingles.de/magazin/autor/${slug}`,
    image: author.avatar
      ? `https://gastrosingles.de/magazin${author.avatar}`
      : undefined,
