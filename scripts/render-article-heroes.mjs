...
const PROMPTS = {
  ...
  // --- Ausbildung-Spokes (2026-06-11) ---
  'koch-ausbildung': `Young German apprentice cook at a professional gas stove in a busy restaurant kitchen, steam rising from pans, kitchen brigade working blurred in background, focused concentrated expression, warm kitchen light, stainless steel surfaces. ${BASE}. No text, no logos.`,
  'hotelfachfrau-ausbildung': `Young German hotel trainee in elegant uniform at a marble hotel reception desk, soft morning light in modern lobby, checking documents with focused friendly expression, elegant 4-star hotel interior blurred behind. ${BASE}. No text, no logos, no readable name badges.`,
  'sommelier-ausbildung': `Young aspiring sommelier examining a glass of red wine against cellar light during a tasting course, rows of wine bottles and tasting notes on wooden table, concentrated expression, warm cellar atmosphere. ${BASE}. No text, no readable labels, no logos.`,
  'barkeeper-ausbildung': `Young bartender apprentice shaking a cocktail shaker behind a modern bar during training, backlit bottle shelf, focused learning expression, moody warm bar light with subtle neon accents. ${BASE}. No text, no readable bottle labels, no logos.`,
  'restaurantfachfrau-ausbildung': `Young German service trainee setting an elegant restaurant table with polished cutlery and folded napkins, bright midday light through restaurant windows, concentrated careful movements, fine-dining interior. ${BASE}. No text, no logos.`,
  'kellner-ausbildung': `Young waiter balancing a loaded serving tray through a full German restaurant in the evening, warm pendant lighting, guests blurred at tables, focused confident movement. ${BASE}. No text, no logos.`,
  'patissier-ausbildung': `Young patisserie apprentice piping cream onto an elegant dessert with a piping bag in a stainless steel pastry kitchen, delicate concentration, soft daylight, marble work surface with baking tools. ${BASE}. No text, no logos.`,
  ...
  // --- DEHOGA NRW-Regionalverbände (Symbolbilder, KEINE Gesichter/Personen) ---
  'dehoga-nordrhein': `Traditional Rhineland brewery (Koelsch Brauhaus) interior in Cologne, empty cozy dining room with dark wooden tables and benches, a round serving tray of slim Koelsch beer glasses on the bar counter in the foreground, brass railings and warm pendant lamps, Rhine-city pub atmosphere at dusk, no people, no faces. photorealistic, Canon R5 35mm, golden hour warm light, shallow depth of field, documentary food photography. No text, no logos, no readable signage.`,
  'dehoga-westfalen': `Cozy traditional Westphalian country inn (Gasthof) interior between Ruhr region and Muensterland, rustic dark wood panelling, a wooden board with hearty regional food (dark Pumpernickel bread, Westphalian ham) and a pewter beer mug on a sturdy table, warm lamp light, authentic rural western-German wirtshaus atmosphere in the evening, no people, no faces. photorealistic, Canon R5 35mm, warm light, shallow depth of field, documentary food photography. No text, no logos, no readable signage.`,
};
